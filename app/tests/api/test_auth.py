...
def test_login(client):
    # логин по юзернэйму
    login_data_username = {"username": "newuser", "password": "newpassword"}
    ...
    # логин по эмеэйлу
    login_data_email = {"email": "newuser@example.com", "password": "newpassword"}
    ...
    # логин по телефону
    phone_data_email = {"phone": "+1987654321", "password": "newpassword"}
...
def test_login_invalid_credentials(client):
    login_data = {"username": "newuser", "password": "wrongpassword"}
